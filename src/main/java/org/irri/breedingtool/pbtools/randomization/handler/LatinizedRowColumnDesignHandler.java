...
import org.irri.breedingtool.pbtools.randomization.dialog.LatinizedRowColumnDesignDialog;
import org.irri.breedingtool.pbtools.randomization.dialog.RowColumnDesignDialog;
...
public class LatinizedRowColumnDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		LatinizedRowColumnDesignDialog designDialog = new LatinizedRowColumnDesignDialog(parent);
		designDialog.open();
