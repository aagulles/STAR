...
public class IncompleteBlockIncompleteBlockAlphaLatticeDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		IncompleteBlockAlphaLatticeDesignDialog designDialog = new IncompleteBlockAlphaLatticeDesignDialog(parent);
		designDialog.open();
