...
import org.irri.breedingtool.pbtools.randomization.dialog.PRepDesignDialog;
...
public class PRepDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		String dialogTitle = "P-Rep Design";
		...
		PRepDesignDialog designDialog = new PRepDesignDialog(parent);
		designDialog.open();
