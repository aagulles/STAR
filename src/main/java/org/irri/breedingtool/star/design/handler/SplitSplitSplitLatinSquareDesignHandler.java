...
import org.irri.breedingtool.star.design.dialog.SplitSplitSplitLatinSquareDesignDialog;
...
public class SplitSplitSplitLatinSquareDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		SplitSplitSplitLatinSquareDesignDialog designDialog = new SplitSplitSplitLatinSquareDesignDialog(parent);
		designDialog.open();
