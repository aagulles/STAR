...
import org.irri.breedingtool.star.design.dialog.IncompleteBlockBalancedIncompleteBlockDesignDialog;




public class IncompleteBlockBalancedIncompleteBlockDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		IncompleteBlockBalancedIncompleteBlockDesignDialog designDialog = new IncompleteBlockBalancedIncompleteBlockDesignDialog(parent);
		designDialog.open();
