...
public class LatinSquareDesignDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		txtNumFactors.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e) {
				if(txtNumFactors.getSelection() > 10){
...
//				}
	...
	protected void okPressed(){  
		...
		if(totalInt > 11){
			MessageDialog.open(SWT.ERROR, this.getShell(), "Error", "Levels of the treatment or treatment combination must be less than or equal to 11. ", SWT.ERROR);
			return;	
		}
