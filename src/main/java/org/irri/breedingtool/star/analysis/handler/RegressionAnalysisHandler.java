...
import org.irri.breedingtool.star.analysis.dialog.LinearRegressionAnalysisDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class RegressionAnalysisHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		LinearRegressionAnalysisDialog analysisDialog = new LinearRegressionAnalysisDialog(parent);
