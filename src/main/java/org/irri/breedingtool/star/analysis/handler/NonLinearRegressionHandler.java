...
import org.irri.breedingtool.star.analysis.dialog.NonLinearRegressionDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class NonLinearRegressionHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		NonLinearRegressionDialog analysisDialog = new NonLinearRegressionDialog(parent);
