...
import org.irri.breedingtool.star.analysis.dialog.ClusterAnalysisDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class ClusterAnalysisHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		ClusterAnalysisDialog analysisDialog = new ClusterAnalysisDialog(parent);
