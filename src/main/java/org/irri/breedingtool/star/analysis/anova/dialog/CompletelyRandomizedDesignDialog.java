...
public class CompletelyRandomizedDesignDialog extends Dialog {
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Completely Randomized Design (CRD) : "
	...
	protected Control createDialogArea(Composite parent) {
		...
		gd_btnResponseVariable.heightHint = 20;
		...
		btnPerformCombined.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true,
				true, 2, 1));
		...
		GridData gd_btnAddCombinedAnalysis = new GridData(SWT.LEFT, SWT.CENTER,
				false, false, 1, 1);
		gd_btnAddCombinedAnalysis.heightHint = 25;
		...
		txtCombinedAnalysis.setTouchEnabled(true);
		txtCombinedAnalysis.setBackground(SWTResourceManager
				.getColor(SWT.COLOR_WHITE));
		txtCombinedAnalysis.setLayoutData(new GridData(SWT.FILL, SWT.CENTER,
				true, false, 1, 1));
	...
	protected void okPressed() {
		...
		if (validateCmpModel()) {
			OperationProgressDialog rInfo = new OperationProgressDialog(
					getShell(), "Performing Analysis of Variance");
			rInfo.open();
			...
			StarAnalysisUtilities.testVarArgs(filePath.replace(File.separator, "/"),
					outputFolderPath.replace(File.separator, "/"), "CRD",
					lstResponse.getItems(), lstFactors.getItems(), null, null,
					null, null, null, btnDisplay1.getSelection(),
					btnDisplay2.getSelection(), btnDisplay3.getSelection(),
					null, postHocVar, postHocOpts,
					(double) txtSignificantLevel.getSelection() / 100);
			...
			try {
					...
					if(btnPerformCombined.getSelection())
						...
						preHocResult = ProjectExplorerView.rJavaManager
								...
								.doANOVACombined(filePath.replace(File.separator, "/"),
