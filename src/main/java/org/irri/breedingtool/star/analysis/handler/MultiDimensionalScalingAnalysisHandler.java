...
public class MultiDimensionalScalingAnalysisHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		MultidimensionalScalingAnalysisDialog analysisDialog = new MultidimensionalScalingAnalysisDialog(parent);
