...
import org.irri.breedingtool.star.analysis.dialog.TTestIndependentSampleDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class TTestIndependentSampleHandler {
	...
	public void launchDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		TTestIndependentSampleDialog analysisDialog = new TTestIndependentSampleDialog(parent);
