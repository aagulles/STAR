...
import org.irri.breedingtool.star.analysis.dialog.NonParametricTwoIndependentSamplesDialog;
import org.irri.breedingtool.utility.GeneralUtility;


public class NonParametricTwoIndependentSamplesHandler {
	...
	public void launchDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		NonParametricTwoIndependentSamplesDialog analysisDialog = new NonParametricTwoIndependentSamplesDialog
				(parent);
