...
import org.irri.breedingtool.star.analysis.dialog.PrincipalComponentAnalysisDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class PrincipalComponentAnalysisHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		PrincipalComponentAnalysisDialog analysisDialog = new PrincipalComponentAnalysisDialog(parent);
		if(DialogHandler.openDialog(PartStackHandler.getActiveElementID() + this.getClass().getName() , analysisDialog))
			analysisDialog.open();
