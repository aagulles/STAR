...
import org.irri.breedingtool.star.analysis.anova.dialog.RandomizedCompleteBlockDesignDialog;
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		RandomizedCompleteBlockDesignDialog analysisDialog = new RandomizedCompleteBlockDesignDialog(
				parent);
