...
import org.irri.breedingtool.star.analysis.anova.dialog.LatinSquareDesignDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class LatinSquareDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,
		...
		LatinSquareDesignDialog analysisDialog = new LatinSquareDesignDialog(
				parent);
