...
import org.irri.breedingtool.star.analysis.dialog.NonParametricOneSampleTestDialog;
import org.irri.breedingtool.utility.GeneralUtility;


public class NonParametricOneSampleHandler {
	...
	public void launchDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		NonParametricOneSampleTestDialog analysisDialog = new NonParametricOneSampleTestDialog(parent);
