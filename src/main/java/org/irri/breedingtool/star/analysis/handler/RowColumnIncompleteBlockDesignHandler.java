...
import org.irri.breedingtool.star.analysis.dialog.RowColumnIncompleteBlockDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class RowColumnIncompleteBlockDesignHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		RowColumnIncompleteBlockDialog analysisDialog = new RowColumnIncompleteBlockDialog(parent);
