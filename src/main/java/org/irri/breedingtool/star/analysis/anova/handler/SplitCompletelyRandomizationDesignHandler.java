...
import org.irri.breedingtool.star.analysis.anova.dialog.SplitCompletelyRandomizedDesignDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class SplitCompletelyRandomizationDesignHandler {
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		SplitCompletelyRandomizedDesignDialog analysisDialog = new SplitCompletelyRandomizedDesignDialog(
				parent);
