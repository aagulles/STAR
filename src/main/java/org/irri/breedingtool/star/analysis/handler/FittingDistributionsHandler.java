...
import org.irri.breedingtool.star.analysis.dialog.DistributionFittingDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class FittingDistributionsHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		DistributionFittingDialog analysisDialog = new DistributionFittingDialog(parent);
