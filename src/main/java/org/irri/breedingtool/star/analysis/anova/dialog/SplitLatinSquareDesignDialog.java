...
public class SplitLatinSquareDesignDialog extends Dialog {
	...
	private String design = "SplitLSD";
	 ...
	 * @param parentShell
	 */
	public SplitLatinSquareDesignDialog(Shell parentShell) {
		super(parentShell);
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Split Plot Design (LSD) : "
	...
	protected Control createDialogArea(Composite parent) {
		...
		GridData gd_lstFactorVariables = new GridData(SWT.FILL, SWT.FILL, true,
				true, 2, 9);
		gd_lstFactorVariables.widthHint = 132;
		...
		GridData gd_btnPerformCombined = new GridData(SWT.FILL, SWT.CENTER,
				true, false, 2, 1);
		gd_btnPerformCombined.widthHint = 181;
		...
		gd_txtCombinedAnalysis.widthHint = 166;
		...
		lblFactors_1.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1));
		lblFactors_1.setText("Mainplot Factor(s)");
		...
		lblSubPlotFactors.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true,
				false, 1, 1));
		lblSubPlotFactors.setText("Subplot Factor(s)");
