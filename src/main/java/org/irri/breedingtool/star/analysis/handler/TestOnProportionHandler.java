...
import org.irri.breedingtool.star.analysis.dialog.TestOnProportionDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class TestOnProportionHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		TestOnProportionDialog analysisDialog = new TestOnProportionDialog(parent);
