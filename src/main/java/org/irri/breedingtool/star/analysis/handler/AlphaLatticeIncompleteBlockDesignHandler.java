...
import org.irri.breedingtool.star.analysis.dialog.AlphaLatticeIncompleteBlockDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class AlphaLatticeIncompleteBlockDesignHandler {
	@Execute
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		AlphaLatticeIncompleteBlockDialog analysisDialog = new AlphaLatticeIncompleteBlockDialog(parent);
