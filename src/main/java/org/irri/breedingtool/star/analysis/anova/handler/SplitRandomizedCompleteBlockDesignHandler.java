...
import org.irri.breedingtool.star.analysis.anova.dialog.SplitRandomizedCompleteBlockDesignDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class SplitRandomizedCompleteBlockDesignHandler {
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		SplitRandomizedCompleteBlockDesignDialog analysisDialog = new SplitRandomizedCompleteBlockDesignDialog(
				parent);
