...
import org.irri.breedingtool.star.analysis.dialog.MultipleLinearRegressionAnalysisDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class MultipleLinearRegressionHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		MultipleLinearRegressionAnalysisDialog analysisDialog = new MultipleLinearRegressionAnalysisDialog(parent);
