...
import org.irri.breedingtool.star.analysis.dialog.DescriptiveStatisticsHeteroskedasticityDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class DescriptiveStatisticsHeteroskedasticityHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		DescriptiveStatisticsHeteroskedasticityDialog analysisDialog = new DescriptiveStatisticsHeteroskedasticityDialog(parent);
