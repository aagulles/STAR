...
import org.irri.breedingtool.star.analysis.dialog.TTestOneSampleDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class TTestOneSampleHandler {
	...
	public void launchDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		TTestOneSampleDialog analysisDialog = new TTestOneSampleDialog(parent);
