...
import org.irri.breedingtool.star.analysis.dialog.DescriptiveStatisticsCrossTabulationDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class DescriptiveStatisticsCrossTabulationHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		DescriptiveStatisticsCrossTabulationDialog analysisDialog = new DescriptiveStatisticsCrossTabulationDialog(parent);
