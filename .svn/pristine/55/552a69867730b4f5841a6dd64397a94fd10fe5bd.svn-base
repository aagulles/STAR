...
import org.irri.breedingtool.pbtools.randomization.dialog.IncompleteBlockLatticeDesignDialog;
...
public class IncompleteBlockLatticeDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		IncompleteBlockLatticeDesignDialog designDialog = new IncompleteBlockLatticeDesignDialog(parent);
		designDialog.open();
