...
import org.irri.breedingtool.star.design.dialog.RandomizedCompleteBlockDesignDialog;
...
public class RandomizedCompleteBlockDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		RandomizedCompleteBlockDesignDialog factorialDesignDialog = new RandomizedCompleteBlockDesignDialog(
				parent);
