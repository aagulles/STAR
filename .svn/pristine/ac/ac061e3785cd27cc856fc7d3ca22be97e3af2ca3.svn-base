...
import org.irri.breedingtool.star.analysis.dialog.DiscriminantAnalysisDialog;
import org.irri.breedingtool.star.analysis.dialog.MultidimensionalScalingAnalysisDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class DiscriminantAnalysisHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		DiscriminantAnalysisDialog analysisDialog = new DiscriminantAnalysisDialog(parent);
