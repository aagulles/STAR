...
import org.irri.breedingtool.star.design.dialog.SplitSplitSplitCompletelyRandomizedDesignDialog;
...
public class SplitSplitSplitCompletelyRandomizationDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		SplitSplitSplitCompletelyRandomizedDesignDialog designDialog = new SplitSplitSplitCompletelyRandomizedDesignDialog(parent);
		designDialog.open();
