...
import org.irri.breedingtool.star.analysis.anova.dialog.SplitSplitSplitRandomizedCompleteBlockDesignDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class SplitSplitSplitRandomizedCompleteBlockDesignHandler {
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		SplitSplitSplitRandomizedCompleteBlockDesignDialog analysisDialog = new SplitSplitSplitRandomizedCompleteBlockDesignDialog(
				parent);
