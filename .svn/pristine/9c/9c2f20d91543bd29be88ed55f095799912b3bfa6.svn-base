...
import org.irri.breedingtool.star.analysis.anova.dialog.SplitSplitSplitCompletelyRandomizedDesignDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class SplitSplitSplitCompletelyRandomizationDesignHandler {
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		SplitSplitSplitCompletelyRandomizedDesignDialog analysisDialog = new SplitSplitSplitCompletelyRandomizedDesignDialog(
				parent);
