...
public class AugmentedRCBIncompleteBlockDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public AugmentedRCBIncompleteBlockDialog(Shell parentShell) {
		super(parentShell);
		setShellStyle(SWT.DIALOG_TRIM | SWT.MIN | SWT.RESIZE);
	}
	protected void configureShell(Shell shell) {
		super.configureShell(shell);
		shell.setText("Augmented RCB: " + new File(filePath).getName());
	...
	protected Control createDialogArea(Composite parent) {
		...
		btnSetToFactor.setText("Set to Factor");
						...
						GridData gd_lstFactorVariables = new GridData(SWT.FILL, SWT.FILL, true, false, 1, 3);
		...
		btnAddBlk.setFont(SWTResourceManager.getFont("Tahoma", 8, SWT.NORMAL));
				...
				Label lblBlock = new Label(composite, SWT.NONE);
