...
public class SplitSplitLatinSquareDesignDialog extends Dialog {
	...
	private String design = "Split2LSD";
	 ...
	 * @param parentShell
	 */
	public SplitSplitLatinSquareDesignDialog(Shell parentShell) {
		super(parentShell);
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Split- Split Plot Design (LSD) : "
	...
	protected Control createDialogArea(Composite parent) {
		...
		gd_txtCombinedAnalysis.widthHint = 172;
