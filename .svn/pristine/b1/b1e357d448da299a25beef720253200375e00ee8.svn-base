...
public class SplitSplitSplitLatinSquareDesignDialog extends Dialog {
	...
	private String design = "Split3LSD";
	...
	private Button btnSubSubSubPlot;
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Split- Split- Split Plot Design (LSD) : "
	...
	btnDisplay3.setText("Bartlett's Test for Homogeneity of Variances");
		...
		lblSubsubPlotFactors.setLayoutData(new GridData(SWT.FILL, SWT.FILL,
				true, false, 1, 1));
		lblSubsubPlotFactors.setText("Sub-subplot Factor(s)");
		...
		lblSubsubsubPlotFactors.setLayoutData(new GridData(SWT.FILL, SWT.FILL,
				true, false, 1, 1));
		lblSubsubsubPlotFactors.setText("Sub-sub-subplot Factor(s)");

		btnSubSubSubPlot = new Button(cmpModel, SWT.NONE);
		...
		GridData gd_txtColumnBlock = new GridData(SWT.FILL, SWT.CENTER, true,
				true, 1, 1);
		gd_txtColumnBlock.heightHint = 18;
	...
	protected void buttonPressed(int buttonId) {
		if (IDialogConstants.OK_ID == buttonId) {
			...
			btnSubSubSubPlot.setText("Add");
			btnSubSubSubPlot.setEnabled(false);
