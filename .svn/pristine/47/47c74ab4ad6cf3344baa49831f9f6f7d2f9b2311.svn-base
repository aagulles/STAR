...
import org.irri.breedingtool.star.design.dialog.IncompleteBlockRectangularLatticeDesignDialog;




public class IncompleteBlockRectangularLatticeDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		IncompleteBlockRectangularLatticeDesignDialog designDialog = new IncompleteBlockRectangularLatticeDesignDialog(parent);
		designDialog.open();
