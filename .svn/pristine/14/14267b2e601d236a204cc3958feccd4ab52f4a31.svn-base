...
public class RowColumnIncompleteBlockDialog  extends Dialog {
	 ...
	 * @param parentShell
	 */
	public RowColumnIncompleteBlockDialog(Shell parentShell) {
		super(parentShell);
		setShellStyle(SWT.DIALOG_TRIM | SWT.MIN | SWT.RESIZE);
	}
	protected void configureShell(Shell shell) {
		super.configureShell(shell);
		shell.setText("Row - Column: " + new File(filePath).getName());
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		btnSetToFactor.setText("Set to Factor");
						...
						GridData gd_lstFactorVariables = new GridData(SWT.FILL, SWT.FILL, true, false, 1, 5);
		...
		txtRep = new Text(composite, SWT.BORDER);
		...
		btnAddRow.setFont(SWTResourceManager.getFont("Tahoma", 8, SWT.NORMAL));
				...
				txtRow.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
				...
				txtCol.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
