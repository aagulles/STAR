...
import org.irri.breedingtool.star.analysis.dialog.IncompleteBlockDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class UnbalancedAnalysisHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		IncompleteBlockDialog analysisDialog = new IncompleteBlockDialog(parent, "UnbalancedAnalysis", new File(PartStackHandler.getActiveElementID()));
