...
import org.irri.breedingtool.star.design.dialog.SplitPlotCompletelyRandomizedDesignDialog;



public class SplitPlotCompletelyRandomizationDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		SplitPlotCompletelyRandomizedDesignDialog designDialog = new SplitPlotCompletelyRandomizedDesignDialog(parent);
		designDialog.open();
