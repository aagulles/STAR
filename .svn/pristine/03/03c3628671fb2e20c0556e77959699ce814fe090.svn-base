...
public class SplitSplitSplitLatinSquareDesignDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblSubsubPlot_1.setText("Sub-subplot");
		...
		lblSubsubPlot.setText("Sub-sub-subplot");
		...
		lblNumberOfTr.setText("Number of Subplots along the Length of Each Mainplot");
		...
		lblNumberOfRows.setText("Number of Sub-subplots along the Length of Each Subplot");
		...
		lblNumberOfSubsub.setText("Number of Sub-sub-subplots along the Length of Each Sub-subplot");
	...
	protected void okPressed(){  	
		...
		if (txtRowsPerSub.getSelection() > txtSubSubPlotFactorLevels.getSelection()){
			MessageDialog.open(SWT.ERROR, this.getShell(), "Error", "Number of plots along the length of each sub plot should be less than or equal to the levels of the sub-sub plot factor and must divider the levels of the sub-sub plot factor", SWT.ERROR);
			return;
		}
		...
		if (txtRowsPerSubSub.getSelection() > txtSubSubSubPlotFactorLevels.getSelection()){
			MessageDialog.open(SWT.ERROR, this.getShell(), "Error", "Number of plots along the length of each sub-sub plot should be less than or equal to the levels of the sub-sub-sub plot factor and must divider the levels of the sub-sub-sub plot factor", SWT.ERROR);
			return;
		}
