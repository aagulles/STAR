...
import org.irri.breedingtool.star.analysis.dialog.NonParametricTwoRelatedSamplesDialog;
import org.irri.breedingtool.utility.GeneralUtility;


public class NonParametricTwoRelatedSamplesHandler {
	...
	public void launchDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		NonParametricTwoRelatedSamplesDialog analysisDialog = new NonParametricTwoRelatedSamplesDialog(parent);
