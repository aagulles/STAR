...
import org.irri.breedingtool.star.analysis.dialog.ChiSquareGoodnessOfFitDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class ChiSquareGoodnessOfFitHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		ChiSquareGoodnessOfFitDialog analysisDialog = new ChiSquareGoodnessOfFitDialog(parent);
