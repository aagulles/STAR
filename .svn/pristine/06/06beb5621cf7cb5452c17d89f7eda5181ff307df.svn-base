...
import org.irri.breedingtool.star.design.dialog.StripSplitPlotDesignDialog;
...
public class StripSplitPlotDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		StripSplitPlotDesignDialog designDialog = new StripSplitPlotDesignDialog(parent);
		designDialog.open();
