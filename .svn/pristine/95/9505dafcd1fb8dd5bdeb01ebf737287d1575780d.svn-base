...
import org.irri.breedingtool.star.analysis.dialog.AugmentedLSIncompleteBlockDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class AugmentedLSIncompleteBlockDesignHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		AugmentedLSIncompleteBlockDialog analysisDialog = new AugmentedLSIncompleteBlockDialog(parent);
