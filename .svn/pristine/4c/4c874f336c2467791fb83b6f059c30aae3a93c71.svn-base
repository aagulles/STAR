...
import org.irri.breedingtool.star.analysis.dialog.AugmentedRCBIncompleteBlockDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class AugmentedRCBIncompleteBlockDesignHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		AugmentedRCBIncompleteBlockDialog analysisDialog = new AugmentedRCBIncompleteBlockDialog(parent);
