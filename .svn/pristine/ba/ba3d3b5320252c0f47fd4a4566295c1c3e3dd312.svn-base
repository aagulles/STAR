...
import org.irri.breedingtool.star.analysis.anova.dialog.SplitSplitCompletelyRandomizedDesignDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class SplitSplitCompletelyRandomizationDesignHandler {
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		SplitSplitCompletelyRandomizedDesignDialog analysisDialog = new SplitSplitCompletelyRandomizedDesignDialog(
				parent);
