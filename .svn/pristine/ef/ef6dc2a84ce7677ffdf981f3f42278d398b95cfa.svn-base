...
import org.irri.breedingtool.star.analysis.dialog.DescriptiveStatisticsNormalityTestDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class DescriptiveStatisticsNormalityTestHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		DescriptiveStatisticsNormalityTestDialog analysisDialog = new DescriptiveStatisticsNormalityTestDialog(parent);
