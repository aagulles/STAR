...
import org.irri.breedingtool.star.analysis.dialog.BalancedIncompleteBlockDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class BalancedIncompleteBlockDesignHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		BalancedIncompleteBlockDialog analysisDialog = new BalancedIncompleteBlockDialog(parent);
