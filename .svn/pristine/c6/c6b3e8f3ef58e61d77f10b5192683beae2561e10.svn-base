...
import org.irri.breedingtool.star.design.dialog.SplitSplitPlotCompletelyRandomizedDesignDialog;



public class SplitSplitPlotCompletelyRandomizationDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		SplitSplitPlotCompletelyRandomizedDesignDialog designDialog = new SplitSplitPlotCompletelyRandomizedDesignDialog(parent);
		designDialog.open();
