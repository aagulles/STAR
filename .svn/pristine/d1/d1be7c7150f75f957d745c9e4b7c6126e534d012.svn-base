...
public class SplitCompletelyRandomizedDesignDialog extends Dialog {
	...
	private String design = "SplitCRD";
	 ...
	 * @param parentShell
	 */
	public SplitCompletelyRandomizedDesignDialog(Shell parentShell) {
		super(parentShell);
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Split Plot Design (CRD) : "
	...
	protected Control createDialogArea(Composite parent) {
		...
		gd_txtCombinedAnalysis.widthHint = 158;
	...
	protected void okPressed() {
		...
		if (validateCmpModel()) {
			...
			StarAnalysisUtilities.testVarArgs(filePath.replace(File.separator, "/"),
					outputFolderPath.replace(File.separator, "/"), "SplitCRD",
					lstResponse.getItems(), lstFactors.getItems(),
					lstSubPlot.getItems(), null, null, txtReplicate.getText(),
