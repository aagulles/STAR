...
import org.irri.breedingtool.star.analysis.anova.dialog.StripPlotDesignDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class StripPlotDesignHandler {
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		StripPlotDesignDialog analysisDialog = new StripPlotDesignDialog(parent);
