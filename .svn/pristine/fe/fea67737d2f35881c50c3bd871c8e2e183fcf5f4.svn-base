...
import org.irri.breedingtool.star.design.dialog.SplitSplitPlotRandomizedCompleteBlockDesignDialog;



public class SplitSplitPlotRandomizedCompleteBlockDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		SplitSplitPlotRandomizedCompleteBlockDesignDialog designDialog = new SplitSplitPlotRandomizedCompleteBlockDesignDialog(parent);
		designDialog.open();
