...
import org.irri.breedingtool.pbtools.randomization.dialog.RandomizedCompleteBlockDesignDialog;
...
public class RandomizedCompleteBlockDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		RandomizedCompleteBlockDesignDialog designDialog = new RandomizedCompleteBlockDesignDialog(parent);
		designDialog.open();
	}
}
