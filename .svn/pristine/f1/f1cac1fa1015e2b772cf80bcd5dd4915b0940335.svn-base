...
public class LatinSquareDesignDialog extends Dialog {
	...
	private Text txtRowBlock;
	private Text txtColumnBlock;
	...
	private Button btnRowBlock;
	private Button btnColumnBlock;
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Latin Square Design (LSD) : "
	...
	protected Control createDialogArea(Composite parent) {
		...
		group.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 2, 3));
		group.setText("Set");
		GridLayout gl_group = new GridLayout(2, false);
		gl_group.horizontalSpacing = 17;
		...
		GridData gd_txtCombinedAnalysis = new GridData(SWT.FILL, SWT.CENTER,
				true, false, 1, 1);
		gd_txtCombinedAnalysis.horizontalIndent = 7;
		gd_txtCombinedAnalysis.widthHint = 178;
		...
		lblFactors_1.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1));
		lblFactors_1.setText("Treatment(s)");
	...
	btnDisplay3.setText("Bartlett's Test for Homogeneity of Variances");
		...
		Label lblRowBlock = new Label(cmpModel, SWT.NONE);
		lblRowBlock.setLayoutData(new GridData(SWT.LEFT, SWT.BOTTOM, false,
				false, 1, 1));
		lblRowBlock.setText("Row Block");

		btnRowBlock = new Button(cmpModel, SWT.NONE);
		GridData gd_btnRowBlock = new GridData(SWT.CENTER, SWT.CENTER, false,
				false, 1, 1);
		gd_btnRowBlock.minimumWidth = 76;
		gd_btnRowBlock.minimumHeight = 26;
		gd_btnRowBlock.heightHint = 26;
		gd_btnRowBlock.widthHint = 90;
		btnRowBlock.setLayoutData(gd_btnRowBlock);
		btnRowBlock.setText("Add");

		txtRowBlock = new Text(cmpModel, SWT.BORDER);
		txtRowBlock.setEditable(false);
		txtRowBlock.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		GridData gd_txtRowBlock = new GridData(SWT.FILL, SWT.CENTER, true,
				true, 1, 1);
		gd_txtRowBlock.heightHint = 16;
		txtRowBlock.setLayoutData(gd_txtRowBlock);
		new Label(cmpModel, SWT.NONE);

		Label lblColumnBlock = new Label(cmpModel, SWT.NONE);
		lblColumnBlock.setLayoutData(new GridData(SWT.FILL, SWT.BOTTOM, true,
				false, 1, 1));
		lblColumnBlock.setText("Column Block");

		btnColumnBlock = new Button(cmpModel, SWT.NONE);
		GridData gd_btnColumnBlock = new GridData(SWT.CENTER, SWT.CENTER, true,
				true, 1, 1);
		gd_btnColumnBlock.minimumWidth = 73;
		gd_btnColumnBlock.minimumHeight = 26;
		gd_btnColumnBlock.heightHint = 26;
		gd_btnColumnBlock.widthHint = 90;
		btnColumnBlock.setLayoutData(gd_btnColumnBlock);
		btnColumnBlock.setText("Add");
		txtColumnBlock = new Text(cmpModel, SWT.BORDER);
		txtColumnBlock.setEditable(false);
		txtColumnBlock.setBackground(SWTResourceManager
				.getColor(SWT.COLOR_WHITE));
		GridData gd_txtColumnBlock = new GridData(SWT.FILL, SWT.CENTER, true,
				true, 1, 1);
		gd_txtColumnBlock.heightHint = 15;
		txtColumnBlock.setLayoutData(gd_txtColumnBlock);
		...
		listManager.initializeSingleSelectionList(lstFactorVariables,
				txtColumnBlock, btnColumnBlock);
		listManager.initializeSingleSelectionList(lstFactorVariables,
				txtRowBlock, btnRowBlock);
		listManager.initializeSingleSelectionList(lstFactorVariables,
	...
	protected void buttonPressed(int buttonId) {
		if (IDialogConstants.OK_ID == buttonId) {
			...
			btnRowBlock.setText("Add");
			btnColumnBlock.setText("Add");
			btnRowBlock.setEnabled(false);
			btnColumnBlock.setEnabled(false);
			...
			if (dlgContrast == null || dlgContrast.getShell().isDisposed()) {
				dlgContrast = new ContrastDialog(getShell(),
						lstFactors.getItems(), filePath, outputFolderPath,
	...
	protected void okPressed() {
		...
		if (validateCmpModel()) {
			...
			StarAnalysisUtilities.testVarArgs(filePath.replace(File.separator, "/"),
					outputFolderPath.replace(File.separator, "/"), "LSD",
					lstResponse.getItems(), lstFactors.getItems(), null, null,
					null, txtRowBlock.getText(), txtColumnBlock.getText(),
					btnDisplay1.getSelection(), btnDisplay2.getSelection(),
					btnDisplay3.getSelection(), postHocVar, postHocOpts,
					isContrastReady,
					(double) txtSignificantLevel.getSelection() / 100);
