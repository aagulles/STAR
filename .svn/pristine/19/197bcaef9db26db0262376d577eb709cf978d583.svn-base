...
import org.irri.breedingtool.star.analysis.anova.dialog.StripSplitSplitPlotDesignDialog;
...
public class StripSplitSplitPlotDesignHandler {
	...
	@Execute
	public void launchCompletelyRandomizationDesign(final Shell parent,
			EModelService service, MWindow window) {
		...
		StripSplitSplitPlotDesignDialog analysisDialog = new StripSplitSplitPlotDesignDialog(
				parent);
