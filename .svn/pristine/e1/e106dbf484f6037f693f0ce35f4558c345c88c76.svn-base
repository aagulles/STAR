...
import org.irri.breedingtool.star.design.dialog.SplitSplitSplitRandomizedCompleteBlockDesignDialog;
...
public class SplitSplitSplitRandomizedCompleteBlockDesignHandler {
	...
	public void launchDesignDialog(final Shell parent, EModelService service,  MWindow window) {
		...
		SplitSplitSplitRandomizedCompleteBlockDesignDialog designDialog = new SplitSplitSplitRandomizedCompleteBlockDesignDialog(parent);
		designDialog.open();
