...
public class SplitSplitRandomizedCompleteBlockDesignDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public SplitSplitRandomizedCompleteBlockDesignDialog(Shell parentShell) {
		super(parentShell);
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Split- Split Plot Design (RCBD) : "
	...
	protected Control createDialogArea(Composite parent) {
		...
		txtCombinedAnalysis.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER,
				true, false, 1, 1));
		GridData gd_txtCombinedAnalysis = new GridData(SWT.FILL, SWT.CENTER,
				true, false, 1, 1);
		gd_txtCombinedAnalysis.heightHint = 15;
		gd_txtCombinedAnalysis.widthHint = 161;
