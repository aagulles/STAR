...
import org.irri.breedingtool.star.analysis.dialog.DescriptiveAnalysisDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class DescriptiveAnalysisHandler {
	@Execute
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		DescriptiveAnalysisDialog analysisDialog = new DescriptiveAnalysisDialog(parent);
