...
import org.irri.breedingtool.star.analysis.anova.dialog.StripSplitPlotDesignDialog;
import org.irri.breedingtool.utility.GeneralUtility;

public class StripSplitPlotDesignHandler {
...
if(RJavaManagerInitializer.isProjectActive == false){
		...
		StripSplitPlotDesignDialog analysisDialog = new StripSplitPlotDesignDialog(
				parent);
