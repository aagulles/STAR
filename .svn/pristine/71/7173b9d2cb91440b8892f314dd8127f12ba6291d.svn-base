...
public class SplitRandomizedCompleteBlockDesignDialog extends Dialog {
	...
	private String design = "SplitRCBD";
	 ...
	 * @param parentShell
	 */
	public SplitRandomizedCompleteBlockDesignDialog(Shell parentShell) {
		super(parentShell);
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Split Plot Design (RCBD) : "
	...
	protected Control createDialogArea(Composite parent) {
		...
		Label label = new Label(cmpModel, SWT.HORIZONTAL);
		label.setText("Numeric Variable(s)");
		new Label(cmpModel, SWT.NONE);
		new Label(cmpModel, SWT.NONE);

		Label label_1 = new Label(cmpModel, SWT.NONE);
		...
		GridData gd_group = new GridData(SWT.FILL, SWT.FILL, true, true, 2, 3);
		gd_group.heightHint = 62;
		...
		GridData gd_btnPerformCombined = new GridData(SWT.FILL, SWT.CENTER,
				true, false, 2, 1);
		gd_btnPerformCombined.widthHint = 172;
		...
		gd_txtCombinedAnalysis.widthHint = 157;
	...
	btnDisplay3.setText("Bartlett's Test for Homogeneity of Variances");
		...
		Label lblSubPlot = new Label(cmpModel, SWT.NONE);
		lblSubPlot.setText("Subplot Factor(s)");
	...
	protected void okPressed() {
		...
		if (validateCmpModel()) {
			...
			StarAnalysisUtilities.testVarArgs(filePath.replace(File.separator, "/"),
					...
					lstResponse.getItems(), lstFactors.getItems(),
					lstSubPlot.getItems(), null, null, txtBlock.getText(),
					null, btnDisplay1.getSelection(),
